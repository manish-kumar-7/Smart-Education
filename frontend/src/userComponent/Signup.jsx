    ...
    if (user && user.role) {
      ...
      switch (user.role) {
        ...
        case "owner":
          ...
          break;
        default:
          sessionStorage.removeItem("user"); // unexpected role
          break;
      }
    }
  }, []);
...
<div className="relative w-full">
    ...
    <button
      ...
      className="absolute right-3 top-1/2 -translate-y-1/2 w-6 h-6 flex items-center justify-center rounded-full bg-pink-300 hover:bg-white/20 text-sm transition-all duration-200"
